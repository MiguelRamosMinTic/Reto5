...
function guardarReporte(reporte1, reporte2) {
  $.ajax({
    url: "http://localhost:8080/api/Reservation/report-dates/" + reporte1 + "/" + reporte2,
    type: "GET",
    datatype: "JSON",
    success: function (response) {
...
//       console.log(response)
//       $("#miResultadoReportes2").empty();
//       $("#miResultadoReportes2").append("<table class='default' style='margin: 0 auto; color: aliceblue;'><tr><th>SE HICIERON LAS SIGUIENTES RESERVAS</th><td>" +
//         response.idReservation + "</td></tr></table>");
//       $("#miResultadoReportes2").append("<hr>");
//     }
//   });
// }
